...
const createTask = async (req, res) => {
    try {
        const { title, description, priority, dueDate, assignedTo, checklist, attachments } = req.body;
...
const updateTask = async (req, res) => {
    try {
        ...
        task.todoChecklist = req.body.checklist || task.todoChecklist;
...
const updateTaskChecklist = async (req, res) => {
    try {
        ...
        task.todoChecklist = todoChecklist; // Replac with upadated checklist
...
const getDashboardData = async (req, res) => {
    try {
        // Fetach statistics for the dashboard
        ...
        // Ensure all possible prioritie levels are included
